          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <MotionWrapper type="slideUp" delay={0.2} className="text-center lg:text-left">
              <div className="space-y-8">
                ...
                <MotionWrapper type="slideUp" delay={0.4} className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-center">
                  <Button
                    size="lg"
            ...
            >
              ...
              {/* Trust indicators */}
              <MotionWrapper type="fadeIn" delay={1.0} className="mt-16 sm:col-span-2">
